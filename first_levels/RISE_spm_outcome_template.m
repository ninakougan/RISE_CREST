...
matlabbatch{1}.spm.stats.fmri_spec.sess.regress = struct('names', {}, 'val', {});
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'GainvMissedGain';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [1 -1];
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'AvoidedLossvLoss';
