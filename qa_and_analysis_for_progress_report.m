...
%     %%
    ...
    T_midants1_c1 = [];
    names = [];
    all_regions = filenames(fullfile('/projects/b1108/studies/rise/data/processed/neuroimaging/rois/anticipation/*.nii'));
    for r = 1:length(all_regions)
        [filepath,name,ext] = fileparts(all_regions{r});
        roi = fmri_data(all_regions{r});
    ...
    T_midouts1_c1 = [];
    names = [];
    all_regions = filenames(fullfile('/projects/b1108/studies/rise/data/processed/neuroimaging/rois/outcome/*.nii'));
    for r = 1:length(all_regions)
        [filepath,name,ext] = fileparts(all_regions{r});
        roi = fmri_data(all_regions{r});
