...
if mid==1
    ...
    for sub 1:length(MIDfnames)
        ...
        gainidx = contains(txt.trial_type,"Win5") | contains(txt.trial_type,"Win1.5");
        gainzeroidx = contains(txt.trial_type,"Win0");
        lossidx = contains(txt.trial_type,"Lose5") | contains(txt.trial_type,"Lose1.5");
        losszeroidx = contains(txt.trial_type,"Lose0");
