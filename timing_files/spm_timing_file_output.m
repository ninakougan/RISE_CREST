...
if mid == 1
    ...
    for sub = 1:length(fnames)
        ...
        save(fullfile(savedir, strcat('sub-', pid{sub}, '_ses-', num2str(ses), '_task-mid_run-1_anticipation_timing.mat')), 'onsets','durations','names'); clear onsets durations names
        ...
        save(fullfile(savedir, strcat('sub-', pid{sub}, '_ses-', num2str(ses), '_task-mid_run-1_outcome_timing.mat')), 'onsets','durations','names'); clear onsets durations names
        ...
        names = {'GainAnticipation','Gain0Anticipation','LossAnticipation','Loss0Anticipation','Motor'};
        save(fullfile(savedir, strcat('sub-', pid{sub}, '_ses-', num2str(ses), '_task-mid_run-2_anticipation_timing.mat')), 'onsets','durations','names'); clear onsets durations names
        ...
        onsets{5} = tgt_on2'; durations{5} = tgt_dur2';
        names = {'SuccessWin','UnsuccessWin','SuccessLoss','UnsuccessLoss','Motor'};
        save(fullfile(savedir, strcat('sub-', pid{sub}, '_ses-', num2str(ses), '_task-mid_run-2_outcome_timing.mat')), 'onsets','durations','names'); clear onsets durations names
    end
end
...
if mid == 1
    ...
    for sub = 1:length(fnames)
        ...
        names = {'GainAnticipation','Gain0Anticipation','LossAnticipation','Loss0Anticipation','Motor'};
        try
            save(fullfile(savedir, strcat('sub-', pid{sub}, '_ses-', num2str(ses), '_task-mid_run-1_anticipation_timing.mat')), 'onsets','durations','names');
        catch
            mid_missing_run1{end+1} = pid{sub};
        end clear onsets durations names
        ...
        names = {'GainAnticipation','Gain0Anticipation','LossAnticipation','Loss0Anticipation','Motor'};
        try
        save(fullfile(savedir, strcat('sub-', pid{sub}, '_ses-', num2str(ses), '_task-mid_run-2_anticipation_timing.mat')), 'onsets','durations','names');
    catch
        mid_missing_run2{end+1} = pid{sub};
    end clear onsets durations names
...
if chat == 1
    ...
    for sub = 1:length(fnames)
        ...
        try
            ...
            chatmat_missing{end+1} = pid{sub};
        end
        catch
            chat_missing{end+1} = pid{sub};
        end
        clear onsets durations names anticipation_onsets anticipation_durations anticipation_names
    end
end
