...
%% %MID files
if mid == 1
    MIDfnames = filenames(fullfile(basedir,'/behavioral/sub-*/ses-',num2str(ses),'/beh/3_MID*txt'));
    ...
    tgt_onset1 = ((txt.Var2(matches(txt.Var1, 'Run1Tgt.OnsetTime'))) - (txt.Var2(matches(txt.Var1, 'Run2Fix.OnsetTime')))) ./1000; %motor period
